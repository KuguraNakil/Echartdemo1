<template>
    <div class="timebox">
        <!-- <div class="shortcut" v-if="timeCount.length">
            <p v-for="(item, index) in timeCount" :key="index" @click="jumpShortcut(item.timeDiff)">
                {{ item.title }}
            </p>
        </div> -->
        <!-- 日历部分-->
        <div id="calendar">
            ...
            <div class="month">
                ...
                <div class="time-switch">
                    <!-- 上一年 -->
                    <!-- <div class="arrow hands iconfont icon-xiangzuo" @click="pickPre(currentYear, currentMonth, 'Y')">
                        《
                    </div> -->
                    <!-- 上个月 -->
                    <div class="arrow hands iconfont icon-xiangzuodan" @click="pickPre(currentYear, currentMonth)"><
                    </div>
                    ...
                    <!-- 下个月 -->
                    <div class="arrow hands iconfont icon-xiangyoudan" @click="pickNext(currentYear, currentMonth)">>
                    </div>
                    <!-- 下一年 -->
                    <!-- <div class="arrow hands iconfont icon-xiangyou" @click="pickNext(currentYear, currentMonth, 'Y')">》
                    </div> -->
                </div>
            </div>
            <!-- 星期 -->
            ...
            <div class="days">
                ...
                <div v-for="dayobject in days" :key="dayobject" class="days-item">
                    <!--不是本月day-->
                    <div v-if="dayobject.day.getMonth() + 1 != currentMonth" class="other-day" :class="{
            prohibit:
                ...
                (maxTime && dayobject.day.getTime() > maxTime)
                    ...
                    <div class="current-month" v-else>
                        <div class="item-day" @click="getDayTime(dayobject.day)" :class="[
...
import { Close, ArrowLeft, ArrowRight, DArrowLeft } from '@element-plus/icons-vue';
export default {
    name: '',
    props: {
        isCompletionZero: {
